...
function t_lazyload__init() {
	...
	for (
		var t = document.querySelector('#allrecords'),
			e =
				(t && 'yes' === t.getAttribute('data-tilda-imgoptimoff')
					? (window.lazy_imgoptimoff = 'yes')
					: (window.lazy_imgoptimoff = ''),
				document.querySelectorAll('.t156 .t-img')),
			o = 0;
		o < e.length;
		o++
	)
		...
		setTimeout(function () {
			...
			;(lazyload_img = new LazyLoad({
				...
				/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
					...
					(document.querySelector('.t-mbfix') ||
						((t = document.createElement('div')).classList.add('t-mbfix'),
...
function t_lazyload__onWindowResize() {
	...
	t_lazyload_update(),
		'yes' !== window.lazy_imgoptimoff &&
			((t = document.querySelectorAll('.t-cover__carrier, .t-bgimg, .t-img')),
			Array.prototype.forEach.call(t, function (t) {
...
function t_lazyLoad__appendImgStatToArr(t, e) {
	...
	void 0 !== navigator.sendBeacon &&
		...
		(t = t.getAttribute('src')) &&
			((o = { time: o - e }),
			0 === t.indexOf('https://thumb.tildacdn') && (o.th = 'y'),
			0 === t.indexOf('https://static.tildacdn') && (o.st = 'y'),
		...
		setTimeout(function () {
			...
			'y' !== window['lazy_ok_' + e] &&
				...
				Array.prototype.forEach.call(t, function (t) {
					...
					'string' == typeof str &&
						0 === e.indexOf(o) &&
						(t.classList.remove('loading'), (t.wasProcessed = !1))
				}),
				t_lazyload_update())
		}, 1e4)
}
!(function (t, e) {
	...
	function x(t, e, o) {
		...
		var i,
			...
			r =
				...
				l &&
				window.tn &&
				l.closest('.t396__artboard_scale')
					? ((l = (l =
							(l = l.closest('.t396__artboard')) &&
							l.getAttribute('data-artboard-recid'))
							? 'ab' + l
							: ''),
					  window.tn[l]
							? window.tn[l].scaleFactor || window.tn_scale_factor || 1
		...
		function c(t) {
			return (
				(t.getBoundingClientRect().top + n) * r - i.documentElement.clientTop
			)
		}
		function s(t) {
			return (
				(t.getBoundingClientRect().left + a) * r - i.documentElement.clientLeft
			)
		}
		return (
			!0 !== window.flag_performance_pass3000 &&
			'object' == typeof performance &&
			performance.now() < 3e3
				? (o = 300)
				: (window.flag_performance_pass3000 = !0),
			(i = t.ownerDocument),
			...
			!(
				(e === window
					...
					: c(e) + e.offsetHeight) <=
					c(t) - o ||
				(e === window ? n : c(e)) >= c(t) + 1200 + t.offsetHeight ||
				(e === window ? d() + window.pageXOffset : s(e) + d()) <= s(t) - o ||
				(e === window ? a : s(e)) >= s(t) + o + t.offsetWidth
			)
		)
	}
	function _(t, e, o, i) {
		...
		if (i) {
			var n,
				...
				d = e.clientHeight,
				c =
					((!b(e, 't-slds__bgimg') && !b(e, 't-slds__img')) ||
						b(e, 't827__image') ||
						(!1 ===
							A(
								(c = (c = v(e, 't-slds__wrapper')) || v(e, 't-slds__container'))
							) && (c = v(e, 't-slds__thumbsbullet')),
						A(c) && ((r = c.clientWidth), (d = c.clientHeight))),
					b(e, 'tn-atom') &&
						b(e, 't-bgimg') &&
						A((c = v(e, 'tn-atom__scale-wrapper'))) &&
						((r = (n = z(
							'round',
			...
			if (
				...
				'IMG' === e.tagName
					...
					? ((l = getComputedStyle(e).backgroundPosition) &&
							...
							'50%' == (s = n[1])
								...
								: '100%' == s && (s = 'bottom')),
					  (u =
							'contain' == getComputedStyle(e)['background-size']
								? 'contain'
								: 'cover'),
					  'fixed' == getComputedStyle(e)['background-attachment'] && (m = !0))
					: (m = !0),
				...
				for (var f = x.split(','), g = 0; g < f.length; g++)
					-1 < f[g].indexOf('round:') && (_ = +f[g].split(':')[1]),
						-1 < f[g].indexOf('comm:') &&
							'resize' != (u = f[g].split(':')[1]) &&
							'cover' != u &&
							'contain' != u &&
							(p = !1),
						-1 < f[g].indexOf('skip') && (m = !0),
						-1 < f[g].indexOf('optimoff') && (p = !1)
			1 < _ && ((r = (n = z(u, r, d, _))[0]), (d = n[1])),
				'cover' == u &&
					0 < r &&
					0 < d &&
					r <= 1e3 &&
					((r === 5 * Math.ceil(r / 5) && d === 5 * Math.ceil(d / 5)) ||
						-1 < h.indexOf(r + 'x' + d) ||
						-1 < y.indexOf(r + 'x' + d) ||
						b(e, 'tn-atom') ||
						b(e, 'tn-atom__img') ||
						((r = (n = z(
							(u = b(e, 't-cover__carrier') ? u : 'resize'),
							r,
							d,
							100
						))[0]),
				...
				!0 === p &&
					(i =
						...
						('IMG' != e.tagName && 0 == d)
							? O(i)
							: (function (t, e, o, i, n, a, l) {
									if ('undefined' == o || null == o) return o
									if (
										0 < o.indexOf('.svg') ||
										0 < o.indexOf('.gif') ||
										0 < o.indexOf('.ico') ||
										-1 === o.indexOf('static.tildacdn.') ||
										0 < o.indexOf('-/empty/') ||
										0 < o.indexOf('-/resizeb/')
									)
										return o
									...
									if ('resize' == e) {
										...
										var d = c
											.join('/')
											.replace('/static.tildacdn.com', '/thumb.tildacdn.com')
											.replace('/static.tildacdn.info', '/thumb.tildacdn.com')
									} else {
										if (!(0 < i && 0 < n)) return o
				...
				(i =
					...
					0 === i.indexOf('https://static.tildacdn.com/')
						? i.replace(
					...
					('IMG' === t.tagName || 'IFRAME' === t.tagName
						...
						: (a =
								-1 !== t.style.backgroundImage.indexOf('-gradient(')
									? t.style.backgroundImage.split('), ')[1]
									: a)
						? (t.style.backgroundImage = 'url(' + i + '), ' + a)
						: ((t.style.backgroundImage = 'url(' + i + ')'),
						  (l = i),
						  (x = (x = t).getAttribute('data-content-cover-id')) &&
	...
	function O(t) {
		...
		var e = t.split('/')
		return (
			e.splice(t.split('/').length - 1, 0, '-/format/webp'),
			e
				.join('/')
				.replace('/static.tildacdn.com', '/thumb.tildacdn.com')
				.replace('/static.tildacdn.info', '/thumb.tildacdn.com')
	...
	function p(t, e, o) {
		if ('string' == typeof e && null != e && '' != e) {
			if (
				...
				0 === e.indexOf('https://static.tildacdn.com/'))
			)
				return (
			...
			if (
				-1 !== e.indexOf('https://thumb.tildacdn.com/') &&
				-1 !== e.indexOf('/-/')
			) {
				...
				if (3 < i.length)
					for (var l = 0; l < i.length; l++)
						'' !== i[l] &&
							('til' == i[l].substring(0, 3) &&
								36 == i[l].length &&
								4 == (i[l].match(/-/g) || []).length &&
								(n = i[l]),
							l == i.length - 1 && (a = i[l]))
				'' !== n &&
					'' !== a &&
					m(t, 'https://static3.tildacdn.com/' + n + '/' + a),
					'function' != typeof t_errors__sendCDNErrors &&
	...
	return (
		(t.prototype._showOnLoad = function (e) {
			...
			!e.getAttribute('src') &&
				n.placeholder &&
				e.setAttribute('src', n.placeholder),
				r((o = document.createElement('img')), 'load', function t() {
					null !== n &&
						(t_lazyLoad__appendImgStatToArr(o, i),
				...
				r(o, 'error', function (t) {
					w(e, n.class_loading),
						...
						void 0 !== t.path
							? p(e, t.path[0].currentSrc, i)
							: void 0 !== t.target && p(e, t.target.currentSrc, i)
				}),
				s(e, n.class_loading),
				(i = c()),
		...
		(t.prototype._showOnAppear = function (e) {
			...
			function n() {
				null !== i &&
					(t_lazyLoad__appendImgStatToArr(e, o),
			...
			;('IMG' !== e.tagName && 'IFRAME' !== e.tagName) ||
				...
				r(e, 'error', function (t) {
					d(e, 'load', n),
						...
						void 0 !== t.path
							? p(e, t.path[0].currentSrc, o)
							: void 0 !== t.target && p(e, t.target.currentSrc, o)
				}),
				s(e, i.class_loading)),
				(o = c()),
		...
		(t.prototype._loopThroughElements = function () {
			for (
				...
				(t = o[a]),
					(e.skip_invisible && t.isSkipByPosition && t.isNotUnderScreenRange) ||
						(x(t, e.container, e.threshold) &&
		...
		(t.prototype.loadAnimatedImages = function () {
			...
			function s(t, e) {
				;(o = t),
					'trigger' === (e = e)
						? (n = o.getAttribute('data-animate-sbs-trgels')) &&
						  (i = document.querySelector('[data-elem-id="' + n + '"]'))
						: 'viewport' === e && (i = v(o, 't396'))
				var o,
					i,
					n = A(i) ? u(i) : null
				if (n)
			...
			for (t = 0; t < d; t++)
				(b((a = r[t]), 'tn-atom__img') || b(a, 'tn-atom')) &&
					((o = (e = v(a, 'tn-elem')).getAttribute('data-animate-sbs-opts')),
					('intoview' !== (i = e.getAttribute('data-animate-sbs-event')) &&
						'blockintoview' !== i) ||
						(n = 'viewport'),
					e.getAttribute('data-animate-sbs-trgels') || (n = 'trigger'),
					(l.skip_invisible && null === a.offsetParent) ||
						!o ||
						(s(e, n) &&
							(l.show_while_loading
								? this._showOnAppear(a)
								: this._showOnLoad(a),
							c.push(t),
							(a.wasProcessed = !0))))
			for (; 0 < c.length; )
			...
			;(this._elements = (function (e) {
				...
				return (
					o.forEach(function (t) {
						t.isSkipByPosition =
							null === t.offsetParent &&
							!1 === A(v(t, 't396__carrier-wrapper')) &&
							'fixed' !== t.getAttribute('data-content-cover-parallax')
						var e = v(t, 't-rec')
						A(e) &&
							(t.isNotUnderScreenRange =
								!1 === e.hasAttribute('data-screen-max') &&
								!1 === e.hasAttribute('data-screen-min'))
					}),
					o
				)
			})(
	...
	(window.t_lazyload_updateResize_elem = function (t) {
		...
		null != t &&
			((r =
				'IMG' == (e = t.tagName)
					? ((o = t.getAttribute('src')), '-/resize/')
					: 'undefined' != typeof getComputedStyle
					? ((o = getComputedStyle(t)
							['background-image'].replace('url(', '')
							.replace(')', '')
							.replace(/"/gi, '')),
					  'contain' == getComputedStyle(t)['background-size']
							? '-/contain/'
							: '-/cover/')
					: '-/cover/'),
			null == o ||
				...
				((r = o.indexOf(r) + r.length),
				(i = o.indexOf('/', r)),
				0 < r &&
					0 < i &&
					((n = o.slice(r, i).split('x')),
					(a = t.clientWidth),
					(l = t.clientHeight),
					0 < a &&
						0 < l &&
						(0 < n[0] || 0 < n[1]) &&
						((0 < n[0] && a > n[0]) || (0 < n[1] && l > n[1])) &&
						((0 < n[0] && 100 < a - n[0]) || (0 < n[1] && 100 < l - n[1])) &&
						((r =
							o.slice(0, r) +
							(0 < n[0] ? a : '') +
							'x' +
